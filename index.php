...
if(isset($_SESSION['status'])){
    ...
    <strong>Hi! <?php echo $_SESSION['status']; ?></strong> 
    ...
    <div class="app__container">
        <div class="app__wrapper">
            ...
            <div class="app__desc app__desc_name">
                <p class="app__desc_1">We will collect just two details about you. Let's start with your name! <br><br>If you're an Admin type "admin".</p>
            </div>

            <form action="mobileno.php" method="post">
                <input type="text" name="user_name" class="form_app_text" placeholder="Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Name'">
